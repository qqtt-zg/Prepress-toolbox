...
namespace WindowsFormsApp3.Forms.Controls.Settings
{
    public partial class SettingsPathControl : UserControl
    {
        ...
        private void InitializeExportPathsDataGridView()
        {
             ...
             dgvExportPaths.EditMode = DataGridViewEditMode.EditOnEnter;
        ...
        private void LoadExportPaths()
        {
            try
            {
                ...
                if (checkboxSettingsObj != null)
                {
                    try
                    {
                        ...
                        if (checkboxSettings == null)
                        {
                            ...
                            checkboxSettings = Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, bool>>(json);
                        }
                    }
                    catch
                    {
                ...
                UpdateStatus(exportPaths.Count(Directory.Exists), exportPaths.Count);
            }
            catch (Exception ex)
            {
