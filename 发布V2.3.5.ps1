...
Write-Host "  大诚重命名工具 V2.3.5 发布脚本" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        # 验证安装包
        $installerFile = Join-Path $outputPath "大诚重命名工具_v2.3.5_安装包.exe"
...
Write-Host "  2. 查看发布说明: 版本发布说明_V2.3.5.md" -ForegroundColor White
Write-Host "  3. 创建 Git 标签: git tag -a v2.3.5 -m 'Release V2.3.5'" -ForegroundColor White
Write-Host "  4. 推送到远程仓库: git push origin v2.3.5" -ForegroundColor White
Write-Host ""
